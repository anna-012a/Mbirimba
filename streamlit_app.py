...
# 2. DATABASE CONNECTION (Must come before the header)
try:
    ...
    # This ensures the variables exist even if the database fails
    series_dad, series_mom = 20, 6

# 3. THE HEADER (Your fixed layout)
st.markdown(f"""
